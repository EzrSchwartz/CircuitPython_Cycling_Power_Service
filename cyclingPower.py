...
It was tested with a Quarq Power Meter and was returning the same values that were read from the wahoo cycling computer that was connected to the power meter at the time of testing. 
